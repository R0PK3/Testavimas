...
public class Tests{
    ...
    public static void test(String testFileName) {
        ...
        for (String productName : productNames) {
            WebElement productElement = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(String.format("//h2[@class = 'product-title']/a[text() = '%s']/../../div[@class='add-info']/div[@class='buttons']/input", productName))));
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.className("new-address-next-step-button"))).click();
